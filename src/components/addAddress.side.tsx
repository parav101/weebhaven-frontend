            ...
            <div className="flex-col absolute right-0 inset-y-0 p-8   w-full max-w-screen-sm bg-hero_pattern bg-gray-300 z-40 rounded-md ">
              ...
              <form className="font-sans  text-sm  mx-auto my-2  pt-4 pb-8" onSubmit={handleSubmit}>
                ...
                <div className="relative mb-3 flex">
                  <input type="text" name="city" value={address.city} onChange={handleChange} id="city" className="relative text-gray-dark border-2 peer block   appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                  ...
                  <input type="text" name="state" value={address.state} onChange={handleChange} id="state" className="relative text-gray-dark border-2 peer block  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
