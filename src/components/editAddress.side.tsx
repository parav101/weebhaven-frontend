...
export function Edit_AddressSideBar(props: any) {
  // const [address, props.setNewAddress] = useState<{ name: string; company?: string; phone: string; address: string; city: string; country: string; state: string; pincode: number; isDefault: boolean }>({
  ...
  function handleChange(event: any) {
    ...
    props.setNewAddress((currentAddress: any) => ({
      ...currentAddress,
      [name]: value,
    }));
  }
  ...
  async function handleSubmit(event: { preventDefault: () => void }) {
    ...
    try {
       await axiosApiInstance.post(`${import.meta.env.VITE_APP_API_URL}/edit-address`, {
        ...
        company: props.currentAddress.company,
        phone: props.currentAddress.phone,
        address: props.currentAddress.address,
        ...
        isDefault: props.currentAddress.isDefault,
      });
  ...
  return (
    <>
      ...
      <div className={`top-0 right-0 bottom-0  fixed w-full max-w-screen-sm bg-hero_pattern bg-gray-300 z-40 rounded-md  ease-in-out duration-500 ${props.open ? "translate-x-0 " : "translate-x-full"}`}>
        {props.open ? (
          <>
            <div className="flex-col absolute right-0 inset-y-0 p-8   w-full max-w-screen-sm bg-hero_pattern bg-gray-300 z-40 rounded-md ">
              ...
              <form className="font-sans  text-sm  mx-auto my-2  pt-4 pb-8" onSubmit={handleSubmit}>
                <div className="relative mb-3">
                  <input type="text" name="name" value={props.currentAddress.name} onChange={handleChange} id="full_name" className=" text-gray-dark border-2 peer block w-full  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                ...
                <div className="relative mb-3">
                  <input type="text" name="company" value={props.currentAddress.company} onChange={handleChange} id="Company" className=" text-gray-dark border-2 peer block w-full  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " />
                ...
                <div className="relative mb-3">
                  <input id="tel" type="phone" value={props.currentAddress.phone} onChange={handleChange} name="phone" className=" text-gray-dark border-2 peer block w-full  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                ...
                <div className="relative mb-3">
                  <input type="text" name="address" value={props.currentAddress.address} onChange={handleChange} id="address" className=" text-gray-dark border-2 peer block w-full  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                ...
                <div className="relative mb-3 flex">
                  <input type="text" name="city" value={props.currentAddress.city} onChange={handleChange} id="city" className="relative text-gray-dark border-2 peer block   appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                  ...
                  <input type="text" name="state" value={props.currentAddress.state} onChange={handleChange} id="state" className="relative text-gray-dark border-2 peer block  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                ...
                <div className="relative mb-3">
                  <input type="text" name="pincode" value={props.currentAddress.pincode} onChange={handleChange} id="pincode" className=" text-gray-dark border-2 peer block w-full  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0" placeholder=" " required />
                ...
                <div className="relative mb-3">
                  <select name="country" id="country" value={props.currentAddress.country} onChange={handleChange} className="text-gray-dark border-2 peer block w-full  appearance-none rounded-md  border-gray-400 py-[14px] pl-6 text-sm focus:border-gray-800 focus:outline-none focus:ring-0">
                ...
                <div className="relative flex items-center mb-3">
                  <input id="default-checkbox" type="checkbox" name="isDefault" defaultChecked={props.currentAddress.isDefault} onChange={handleCheck} className="ms-1 w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 rounded focus:ring-gray-500" />
